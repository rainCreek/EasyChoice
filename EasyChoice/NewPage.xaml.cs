       ...
       /// mmmmmmmmmmmm
        ...
        private void modeSelectButtonClick(object sender, RoutedEventArgs e)
        {
            if (modeSelectButton.Label == "Normal")
            {
                ...
                image.ImageSource = new BitmapImage(new Uri("ms-appx:///Assets/NormalBackG.jpg", UriKind.Absolute));
            ...
            else
            {
                ...
                curWrong = 0;
                ImageBrush image = new ImageBrush();
                image.ImageSource = new BitmapImage(new Uri("ms-appx:///Assets/ReviewBackG.png", UriKind.Absolute));
                this.BackgroundImage.Background = image;
            }
            getQuestionFromDB();
        }
